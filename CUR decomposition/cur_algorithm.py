...
def cur(M, c, r, dim_red = None, repeat=None):
    """
    This function applies dimensionality reduction to obtain the C,U and R matrices.
...
def column_selection(M, m_square_sum, c, repeat_allowed=False):
    """
    This function applies the column selection algorithm using the 'random' python library

...
class SVDAlgorithm:
    ...
    def eigen_decomposition(self, M):
        """
        This function is used to return Eigen values and corresponding eigen vectors arranged in descending order.
    ...
    def svd(self, M, dimension_reduction=1.0):
        """
        This function applies Singular Value Decomposition to employ dimensionality reduction to the 
        input matrix M which is finally expressed as U, sigma and V such that M = U * sigma * V
